...
Supported routers:
This app has been developed and tested on Netgear R7800 routers running OpenWRT 24.10 and 25.12. It should be compatible with all OpenWRT routers running firmware 24.10 or higher.
