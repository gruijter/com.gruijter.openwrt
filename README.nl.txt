...
- Monitor en beheer* je wifi-netwerk(en) en de verbonden apparaten
- Blokkeer de WiFi van je kinderen na het avondeten
- Monitor het energieverbruik van je netwerkapparaten, bijv. de TV.

Bekijk en log:
- status van de internetverbinding
- de upload- en downloadsnelheid van het internet
...
- verandering in bandbreedte of wifi-link van een apparaat
...
Router apparaat instellen in Homey:
De app is bedoeld voor OpenWRT-routers die in Router-modus werken. Je kunt OpenWRT-routers toevoegen die zijn geconfigureerd in Access Point (AP)-modus voor betere/snellere detectie van wifi-apparaten in je hele huis. Je Homey moet verbonden zijn binnen het LAN-gedeelte van de router, niet van buitenaf (WAN). Bij het opstarten van de app zal Homey proberen automatisch verkeersstatistieken (upload-/downloadsnelheid) in te schakelen door het nlbwmon-pakket te installeren.

Aanwezigheidsdetectie:
Na het toevoegen van je router aan Homey, kun je beginnen met het toevoegen van de mobiele of vaste apparaten die je wilt volgen voor aanwezigheid.

Energiemonitoring:
Na het toevoegen van je router aan Homey, kun je extra apparaten toevoegen die je wilt monitoren op stroomverbruik, bijv. je TV of printer. Voer in de geavanceerde apparaatinstellingen het geschatte / gemiddelde stroomverbruik van het apparaat in wanneer het UIT of AAN staat. Wanneer je nu je TV aanzet, zul je zien dat het geschatte vermogen wordt opgenomen in het Homey Energie-tabblad.
